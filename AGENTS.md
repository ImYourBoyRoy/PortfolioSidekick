...
- **Capacitor & Mobile SDKs:** Standardize on Capacitor 6/7/8+ which mandates Node >= 22.0.0. Ensure the Gradle wrapper, JDK (Java 17+), and compiler targets remain fully modern.
