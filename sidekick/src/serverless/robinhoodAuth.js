// ./sidekick/src/serverless/robinhoodAuth.js
/**
...
/**
 * Phase 2 — mirrors legacy complete_challenge + robin_stocks push polling.
 */
    ...
    if (!(await isDesktopRustAuth())) {
      ...
      return {
        ...
        message:
          ...
          'Rebuild with .\\scripts\\build-windows.ps1, then run sidekick\\src-tauri\\target\\release\\portfolio-sidekick.exe — ' +
